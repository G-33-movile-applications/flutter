...
class _NewReminderDialogState extends State<NewReminderDialog> {
  ...
  void _initializeFromReminder() {
    if (widget.initialReminder != null) {
      ...
      // Note: _selectedMedicine will be set after medicines are loaded
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      child: Container(
        constraints: const BoxConstraints(minWidth: 320, maxWidth: 600, maxHeight: 700),
        child: Column(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Recibir recordatorios a la hora indicada',
