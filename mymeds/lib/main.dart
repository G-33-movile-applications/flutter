...
Future<void> main() async {
  ...
  // This ensures notifications are properly scheduled after app restart
  if (hasValidSession && UserSession().currentUser.value != null) {
    final userId = UserSession().currentUser.value!.uid;
    debugPrint('🔔 Rescheduling active reminders for user: $userId');
    try {
      await ReminderSchedulingService().rescheduleAllActiveRemindersOnStartup(userId);
